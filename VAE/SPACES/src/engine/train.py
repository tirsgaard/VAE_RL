...
def train(cfg):
    ...
    trainloader, train_dataset = get_dataloader(cfg, 'train')
    cur_seq_length = cfg.train.start_seq_length
    ...
    for epoch in range(start_epoch, cfg.train.max_epochs):
        ...
        for i, data in enumerate(trainloader):     
            ...
            model.train()
            imgs = data # (B,L,C,H,W)
            # We clone images to form sequence of length to test
            ...
            if (global_step) % cfg.train.print_every == 0:
                ...
                print("Sequence length is:" + str(train_dataset.cur_seq_len))
                print("evaluator step is:" + str(train_dataset.global_step))
                print(
